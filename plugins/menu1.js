...
const fgif = {
  key: {
    ...
    ...{from: { remoteJid: "6282273112644-1621306547@g.us" }},
  },
  message: {
    videoMessage: {
      title: `WibuBotz`,
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            orderTitle: 'Subscribe YT WibuBotz',
...
const ftextt = {
	 key: { 
          fromMe: false,
	      participant: `0@s.whatsapp.net`, ...(m.chat ? 
	 { remoteJid: "6282273112644-1621306547@g.us" } : {}) 
                },
	 message: { 
		"extendedTextMessage": {
                 "text":"hallo bang",
...
const freply = {key:{ fromMe:false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: {
	...
	"productImageCount": 1
						...
						"businessOwnerJid": "6282273112644@s.whatsapp.net"}}}    
